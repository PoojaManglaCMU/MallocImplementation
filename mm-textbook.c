...
static void mm_checkheap(char caller, void *ptr, int size);
 ...
 */
void mm_checkheap(char caller, void* caller_ptr, int caller_size)  
{ 
   // lineno = lineno; /* keep gcc happy */
   int size;  // Size of block
  int alloc; // Allocation bit
  char *ptr = heaplistp + DSIZE;
  int block_count = 1;
  int count_size;
  int count_list;
